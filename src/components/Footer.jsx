                                        ...
                                        <div className="content">
                                            ...
                                            <ul className="lab-ul social-icons">
                                                {socialList.map((social, i) => (
                                                    <li key={i}>
                                                       <a href={social.siteLink} className={social.className}><i className={social.iconName}></i></a>
                                                    </li>
                                                ))}
                                            </ul>
                                        </div>
            ...
            <div className="footer-bottom">
                <div className="container">
                    <div className="section-wrapper">
                        <p>&copy; 2024 <Link to={"/"}>Shop Cart</Link> Designed by <a href="https://www.facebook.com/dominicsham00/" target="_blank">Dominic Sham</a> </p>
